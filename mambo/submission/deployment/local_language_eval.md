...
```
uv run python scripts/evaluate_mambo.py --full   # then slice router_accuracy.csv / full_eval.csv by language
```
...
Mambo is **multilingual-ready at the embedding layer** and **not yet at parity**
