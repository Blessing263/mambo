...
2. Mambo returns a **structured card**: Eligibility, What to bring, Steps, Fees,
...
2. Mambo shows an honest status (unsupported / declined) **and a handoff card**:
...
2. Mambo resolves the reference against recent turns (query rewrite) and answers
   in the new context.
