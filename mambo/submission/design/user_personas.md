...
Mambo serves a whole-of-government audience. Three primary personas drive design.
...
- **How Mambo helps:** service-journey cards (eligibility / what to bring / steps /
...
- **How Mambo helps:** a consistent, cited first-line answer; the reviewed-answer
...
- **How Mambo helps:** `query_log` analytics (planned dashboard: top unanswered
