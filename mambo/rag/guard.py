"""Safety guard — abstain from categories Mambo must not answer, and route the
user to a real human/professional path instead.

Scope: official Zimbabwe government information only. Mambo must NOT give medical
