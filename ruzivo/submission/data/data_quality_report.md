# Ruzivo Corpus — Data Quality Report

**Dataset:** Ruzivo Official-Source Knowledge Corpus · **Version:** v1.0.0 (registry 2026-06-07)
...
3. Run the full RAG evaluation (`scripts/evaluate_ruzivo.py --full`) to capture citation coverage, fallback rate, and latency alongside the deterministic router accuracy already recorded.
