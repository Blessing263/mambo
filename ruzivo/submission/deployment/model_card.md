# Ruzivo — Model & System Card

## Overview

Ruzivo is a retrieval-augmented citizen information assistant for the Government of
...
personal-data lookups, political opinions, and prompt injection. Ruzivo does not
...
See `monitoring_plan.md` and `risk_register.csv`. Steward: Ruzivo team
