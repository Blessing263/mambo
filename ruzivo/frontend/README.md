# Ruzivo — National redesign (live-demo frontend)

A reimagined, **national-grade** frontend for **Ruzivo** — the Government of Zimbabwe's
...
> *Ruzivo* means **"knowledge"** in Shona. One assistant across every ministry; answers
...
3. Click **"Find the right office"** → type/pick *"I lost my national ID"* → Ruzivo
