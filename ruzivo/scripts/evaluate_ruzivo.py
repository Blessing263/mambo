...
Usage:
  uv run python scripts/evaluate_ruzivo.py                       # router accuracy, all
  uv run python scripts/evaluate_ruzivo.py --full --limit 10     # + full RAG on 10 Qs
  uv run python scripts/evaluate_ruzivo.py --out eval.csv
"""
