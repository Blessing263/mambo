    ...
    <div className="flex flex-1 flex-col items-center justify-center px-4 pb-10 pt-10 sm:pt-14 animate-fade-up">
      ...
      <div className="mb-8 text-center max-w-2xl">
        ...
        <p className="mt-3 text-[15px] leading-relaxed max-w-lg mx-auto" style={{ color: "var(--text-secondary)" }}>
          Ruzivo answers in plain language using <strong style={{ color: "var(--text-primary)" }}>only official ministry documents</strong>.
  ...
  return (
    <div>
      ...
      <div className="mb-2 flex items-center gap-2">
        ...
        <span className="text-[13px] font-medium" style={{ color: "var(--text-primary)" }}>Ruzivo</span>
        {ministries.map((id) => (
